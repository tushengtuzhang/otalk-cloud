package com.otalk.service.match.redis;

import com.otalk.util.redis.RedisUtils;
import com.otalk.vo.CaseMatchVO;
import com.otalk.vo.ThirdPartyServiceVO;
import org.springframework.stereotype.Service;

import javax.annotation.Resource;
import java.util.concurrent.TimeUnit;

import static com.otalk.service.match.constant.CaseMatchConstant.CASE_MATCH;
import static com.otalk.service.match.constant.CaseMatchConstant.LAST_CASE;
import static com.otalk.service.match.constant.CaseMatchConstant.THIRD_PARTY_SERVICE_VO;
